...
const MainLayout = ({ children }) => {
  return (
    <div className="flex items-start gap-9 mt-8 ml-8">
      <aside className="itmes-center h-[91vh] p-4 w-24 bg-[#161D2F] rounded-2xl">
        <NavLink to='/'>
          <img className="pl-4" src="/logo.svg" alt="Logo" />
        </NavLink>
        <div className="flex items-center h-full flex-col justify-between">
